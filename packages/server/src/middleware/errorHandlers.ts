import { LoginErrorKind, LoginErrors } from '@asw-project/shared/authentication/dto/login';
import { SignupErrorKind, SignupErrors } from '@asw-project/shared/authentication/dto/signup';
import { Error } from '@asw-project/shared/errors';
import { NextFunction, Request, Response } from 'express';
import { StatusCodes } from 'http-status-codes';

type ApplicationError = LoginErrorKind | SignupErrorKind;

export function handleResponse(err: any, _: Request, res: Response, next: NextFunction) {
